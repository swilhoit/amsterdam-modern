    ...
    <div className="max-w-[1800px] mx-auto px-6 lg:px-12 py-8">
      ...
      <section className="bg-foreground text-background py-16 lg:py-24 -mx-6 lg:-mx-12 px-6 lg:px-12 mb-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="font-serif text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed mb-8 italic gallery-reveal stagger-1">
      ...
      <section className="mb-24">
        <h2 className="font-serif text-3xl md:text-4xl font-light mb-12 text-center gallery-reveal">
          What Sets Us Apart
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          <div className="text-center gallery-reveal stagger-1">
            <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center">
              <svg className="w-8 h-8 text-warm" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="text-center gallery-reveal stagger-2">
            ...
            <h3 className="font-serif text-xl mb-4">Curation</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      <section className="text-center py-16 border-t border-border">
        <h2 className="font-serif text-3xl md:text-4xl font-light mb-6 gallery-reveal">
          Visit Our Showroom
        </h2>
